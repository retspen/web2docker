...
from views import IndexView, ContainersView, ContainerView, ContainerAttachView, HostImagesView, HostsView, HostInfoView
...
urlpatterns = [
    ...
    url(r'^attach/(?P<host_id>[0-9]+)/(?P<container_id>[0-9a-f]+)/$', ContainerAttachView.as_view(), name='attach'),
